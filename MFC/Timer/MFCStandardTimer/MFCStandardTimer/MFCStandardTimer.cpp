...
// MFCStandardTimer.cpp: 定義應用程式的類別表現方式。
//
...
BEGIN_MESSAGE_MAP(CMFCStandardTimerApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CMFCStandardTimerApp 建構

CMFCStandardTimerApp::CMFCStandardTimerApp()
{
	// 支援重新啟動管理員
...
// 唯一一個 CMFCStandardTimerApp 物件

CMFCStandardTimerApp theApp;


// CMFCStandardTimerApp 初始化

BOOL CMFCStandardTimerApp::InitInstance()
{
